#!/usr/bin/env python3
"""Build manuscript_v5.docx from manuscript_v5.md + table CSVs (python-docx).
v5: adds B1-B4 decision-impact analyses; embeds Tables 1-5."""
import csv
import re
from docx import Document
from docx.shared import Pt

MD = "/mnt/results/04_manuscript/manuscript_v5.md"
...
T5 = "/mnt/results/04_manuscript/table5_impact_simulation_v5.csv"
OUT = "/workspace/manuscript_v5.docx"
...
while i < len(lines):
    ...
    if in_tables and ln.startswith("**Table 4"):
        ...
        doc.add_paragraph("")
        continue
    if in_tables and ln.startswith("**Table 5"):
        doc.add_paragraph(clean_caption(ln))
        add_table_from_csv(T5, doc, font_size=8)
        doc.add_paragraph("")
        continue
    if ln.startswith("- "):
