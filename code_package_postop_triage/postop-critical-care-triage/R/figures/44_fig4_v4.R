#!/usr/bin/env Rscript
# 44_fig4_v4.R — v4 combined validation figure: corrected INSPIRE outcome,
# deduped MOVER cohort. 2 cohorts x (ROC | calibration).
# Row 1: INSPIRE (same-institution temporal validation, primary cohort)
# Row 2: MOVER (independent external validation, deduplicated)
...
ggsave(file.path(FIG, "fig_validation_combined_v4.svg"), p, width = 9, height = 8.2)
ggsave(file.path(FIG, "fig_validation_combined_v4.png"), p, width = 9, height = 8.2, dpi = 300)
cat("== 44 done ==\n")
